...
def train_and_save(args):
    ...
    _, data_t = data_utils.get_data(d_train, clip_preprocess=lambda x: x, target_preprocess=target_preprocess)
    _, val_data_t = data_utils.get_data(d_val, clip_preprocess=lambda x: x, target_preprocess=target_preprocess)
    ...
    utils.save_target_activations(target_model, data_t, target_save_name, target_layers = [args.feature_layer],
                                  batch_size = 1000, device = args.device, pool_mode='avg')
